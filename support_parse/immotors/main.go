...
func (__instance *Evt_0004) Write(_byteBuf *parse.ByteBuf) {
	_instance := *__instance
	_byteBuf.Write_uint16(_instance.F_evtId)
	_byteBuf.Write_uint16(uint16(util.Round((_instance.F_GnssAlt + 500) / 0.1)))
	_bitBuf := parse.ToBitBuf_writer(_byteBuf)
	_bitBuf.Write(int64(util.Round(_instance.F_Longitude/0.000001)), 29, true, false)
...
func (__instance *Evt_0005) Write(_byteBuf *parse.ByteBuf) {
	...
	_byteBuf.Write_uint16(_instance.F_evtId)
	_bitBuf := parse.ToBitBuf_writer(_byteBuf)
	_bitBuf.Write(int64(util.Round(_instance.F_Latitude/0.000001)), 28, true, false)
	_bitBuf.Skip(2)
	_bitBuf.Write(int64(_instance.F_VehTyp), 2, true, true)
	_bitBuf.Finish()
	_byteBuf.Write_uint16(uint16(util.Round(_instance.F_GNSSDirection / 0.01)))
}
...
func (__instance *Evt_0006) Write(_byteBuf *parse.ByteBuf) {
	...
	_byteBuf.Write_uint16(_instance.F_evtId)
	_bitBuf := parse.ToBitBuf_writer(_byteBuf)
	_bitBuf.Write(int64(util.Round(_instance.F_HDop/0.1)), 24, true, true)
	_bitBuf.Write(int64(util.Round(_instance.F_VDop/0.1)), 24, true, true)
	_bitBuf.Finish()
}
...
func (__instance *Evt_0007) Write(_byteBuf *parse.ByteBuf) {
	...
	_byteBuf.Write_uint16(_instance.F_evtId)
	_bitBuf := parse.ToBitBuf_writer(_byteBuf)
	_bitBuf.Write(int64(util.Round(_instance.F_AcceX/0.0009765625)), 14, true, false)
	_bitBuf.Finish()
	_bitBuf.Write(int64(util.Round(_instance.F_AcceY/0.0009765625)), 14, true, false)
	_bitBuf.Finish()
	_bitBuf.Write(int64(util.Round(_instance.F_AcceZ/0.0009765625)), 14, true, false)
	_bitBuf.Finish()
}
...
func (__instance *Evt_0800) Write(_byteBuf *parse.ByteBuf) {
	...
	_bitBuf.Finish()
	_byteBuf.Write_uint8(uint8(util.Round((_instance.F_SysVol - 3) / 0.1)))
...
func (__instance *Evt_0801) Write(_byteBuf *parse.ByteBuf) {
	...
	_bitBuf := parse.ToBitBuf_writer(_byteBuf)
	_bitBuf.Write(int64(util.Round(_instance.F_BrkPdlPos/0.392157)), 8, true, true)
	_bitBuf.Finish()
}
...
func (__instance *Evt_0802) Write(_byteBuf *parse.ByteBuf) {
	...
	_byteBuf.Write_uint16(_instance.F_evtId)
	_bitBuf := parse.ToBitBuf_writer(_byteBuf)
	_bitBuf.Write(int64(util.Round(_instance.F_VehSpdAvgDrvn/0.015625)), 15, true, true)
...
type Evt_4_x_unknown struct {
	...
	F_data   util.ByteSlice `json:"data"`
}
...
func (__instance *Evt_D006) Write(_byteBuf *parse.ByteBuf) {
	...
	_bitBuf.Write(int64(util.Round((_instance.F_BMSPackCrnt+1000)/0.05)), 16, true, true)
	_bitBuf.Write(int64(_instance.F_BMSPackCrntV), 1, true, true)
	_bitBuf.Write(int64(util.Round(_instance.F_BMSPackSOC/0.1)), 10, true, true)
	_bitBuf.Write(int64(_instance.F_BMSPackSOCV), 1, true, true)
	_bitBuf.Write(int64(util.Round(_instance.F_BMSPackSOCDsp/0.1)), 10, true, true)
	_bitBuf.Write(int64(_instance.F_BMSPackSOCDspV), 1, true, true)
	_bitBuf.Write(int64(_instance.F_ElecVehSysMd), 4, true, true)
	_bitBuf.Write(int64(util.Round(_instance.F_BMSPackVol/0.25)), 12, true, true)
	_bitBuf.Write(int64(_instance.F_BMSPackVolV), 1, true, true)
	_bitBuf.Write(int64(_instance.F_HVDCDCSta), 3, true, true)
	_bitBuf.Write(int64(util.Round((_instance.F_EPTTrInptShaftToq+848)/0.5)), 12, true, true)
	...
	_bitBuf.Write(int64(util.Round(_instance.F_BMSPtIsltnRstc/0.5)), 14, true, true)
	_bitBuf.Write(int64(util.Round(_instance.F_EPTAccelActuPos/0.392157)), 8, true, true)
	...
	_bitBuf.Write(int64(util.Round((_instance.F_TMActuToq+512)/0.5)), 11, true, true)
	_bitBuf.Write(int64(_instance.F_TMActuToqV), 1, true, true)
	_bitBuf.Write(int64(util.Round((_instance.F_ISGActuToq+512)/0.5)), 11, true, true)
	_bitBuf.Write(int64(_instance.F_ISGActuToqV), 1, true, true)
	_bitBuf.Write(int64(_instance.F_SAMActuToqV), 1, true, true)
	_bitBuf.Write(int64(util.Round((_instance.F_SAMActuToq+512)/0.5)), 11, true, true)
	...
	_bitBuf.Write(int64(util.Round(_instance.F_AvgFuelCsump/0.1)), 8, true, true)
	...
	_bitBuf.Write(int64(util.Round((_instance.F_EPTTrOtptShaftTotToq+848)/0.5)), 12, true, true)
...
type Evt_D00B struct {
	...
	F_BMSCellVolV      util.ByteSlice `json:"BMSCellVolV"`
}
...
type Evt_D00C struct {
	...
	F_BMSCellTemV      util.ByteSlice `json:"BMSCellTemV"`
}
...
type Evt_D00D struct {
	...
	F_BMSBusbarTemV      util.ByteSlice `json:"BMSBusbarTemV"`
}
...
func (__instance *Evt_D00F) Write(_byteBuf *parse.ByteBuf) {
	...
	_byteBuf.Write_uint8(uint8(util.Round((_instance.F_BMSBusbarTempMax + 40) / 0.5)))
	_bitBuf := parse.ToBitBuf_writer(_byteBuf)
	...
	_bitBuf.Write(int64(util.Round(_instance.F_BMSBatPrsSnsrValBkup/0.05)), 15, true, true)
	_bitBuf.Write(int64(_instance.F_BMSBatPrsSnsrVBkup), 1, true, true)
	_bitBuf.Write(int64(util.Round(_instance.F_BMSBatPrsSnsrVal/0.05)), 15, true, true)
	_bitBuf.Write(int64(util.Round(_instance.F_BMSClntPumpPWMReq/0.4)), 8, true, true)
	...
	_bitBuf.Write(int64(util.Round((_instance.F_OtsdAirTemCrVal+40)/0.5)), 8, true, true)
